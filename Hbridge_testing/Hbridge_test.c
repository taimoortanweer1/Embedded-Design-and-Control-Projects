...
//		TRANSMIT_C1(0b00000001);
	//	__delay32(40000);
	//	TRANSMIT_C2(0b00000111);
	//	__delay32(40000);
	//	TRANSMIT_C2(0b10100111);
	//	__delay32(40000);

	//	TRANSMIT_C2(0b11110000);
	//	__delay32(40000);
...
while(1)
{
		...
		else if(GET_PS2(p_down)==0)
		{
			BACKWARD1(128,120);
			BACKWARD2(128,120);
		}
		else if(GET_PS2(p_right)==0)
		{
			FORWARD1(128,100);
			BACKWARD2(128,40);
			
		}
		else if(GET_PS2(p_left)==0)
		{
