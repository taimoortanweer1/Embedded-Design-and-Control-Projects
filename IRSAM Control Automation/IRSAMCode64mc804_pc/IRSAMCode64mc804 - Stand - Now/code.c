...
while(1)
{
control(10,0.00000000001,2.1,0.00000000001);  
...
void control(float KP_AZIM , float KI_AZIM , float KP_PITCH , float KI_PITCH)
{
		...
		ERROR_ANGLE_AZIM = ERROR_ANGLE_AZIM - 360;

		else if(ERROR_ANGLE_AZIM < -180) 
		ERROR_ANGLE_AZIM = 360 - ERROR_ANGLE_AZIM;
		...
		ERROR_SPEED_PITCH = ((abs(ERROR_ANGLE_PITCH)/90.000)*105.00)*KP_PITCH + I_ERROR_PITCH; 
